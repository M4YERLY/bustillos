...
// Obtener información del proceso (opcional)
$stmt = $conn->prepare("
    SELECT p.nombre AS proceso_nombre
    FROM procesos p
    WHERE p.id = :proceso_id
");
$stmt->execute([':proceso_id' => $proceso_id]);
...
<!DOCTYPE html>
<html lang="es" class="light-style layout-fixed">
                    ...
                    <div class="authentication-wrapper authentication-basic container-p-y mx-auto col-md-6">
                        <div class="authentication-inner">
                            <div class="card shadow-lg">
                                <div class="card-body">
                                    <h4 class="mb-4 text-center">Subir Documentos para Proceso Terrestre</h4>
