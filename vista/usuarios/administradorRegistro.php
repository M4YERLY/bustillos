...
if (isset($_POST['registrar'])) {
    ...
    try {
        ...
        if ($existe_usuario > 0) {
            ...
            $stmt1 = $conn->prepare("INSERT INTO usuarios (username, email, password, role) VALUES (:username, :email, :password, 'admin')");
            ...
            $stmt2 = $conn->prepare("INSERT INTO administradores 
                (nombre, apellido_paterno, apellido_materno, carnet_identidad, fecha_nacimiento, telefono, direccion, email, usuario_id, foto_perfil) 
                VALUES (:nombre, :apellido_paterno, :apellido_materno, :carnet_identidad, :fecha_nacimiento, :telefono, :direccion, :email, :usuario_id, :foto_perfil)");
                ...
                <div class="container-xxl">
                    <div class="authentication-wrapper authentication-basic container-p-y mx-auto col-md-6">
                        <div class="authentication-inner">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="mb-6">Registrar Nuevo Administrador</h4>
