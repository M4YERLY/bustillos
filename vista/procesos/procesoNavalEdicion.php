...
// Obtener la lista de empleados para el select
    ...
    try {
        ...
        $stmt = $conn->prepare("
            ...
            SET nombre = :nombre, descripcion = :descripcion, punto_origen = :punto_origen, punto_destino = :punto_destino, 
                tipo_carga = :tipo_carga, puerto_principal = :puerto_principal 
            WHERE id = :proceso_id
        ");
        ...
        echo "Error al actualizar el proceso naval: " . $e->getMessage();
    }
}
?>
...
<head>
    ...
    <title>Editar Proceso Naval</title>
                    ...
                    <div class="authentication-wrapper authentication-basic container-p-y mx-auto col-md-6">
                        <div class="authentication-inner">
                            <div class="card shadow-lg">
                                <div class="card-body">
                                    <h4 class="mb-4 text-center">Editar Proceso Naval</h4>
                                    ...
                                    <form method="POST" action="">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 form-group">
                                                ...
                                                <input type="text" class="form-control" id="puerto_principal" name="puerto_principal" value="<?= htmlspecialchars($proceso['puerto_principal']) ?>" required>
                                            </div>
                                        </div>
